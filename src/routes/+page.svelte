<div class="container">
    ...
    <main class="site-content">
        ...
        <section class="page-content">
            <h2>About</h2>
            <p>Welcome to my website. This page is more or less meant to be a placeholder while I focus my efforts on school and other projects. A more complete, overhauled version is in the works, though.</p>
            <p>In the future, I plan to use this site to...</p>
            <ul>
                <li>demonstrate personal software and security projects;</li>
                <li>showcase visual art, including design, illustration, and 3D modeling;</li>
    ...
    <footer class="site-footer">
        <p class="copyright-text">&copy; <span id="copyright-year"></span> Jeremy Kennard. All rights reserved.</p>
    </footer>
</div>